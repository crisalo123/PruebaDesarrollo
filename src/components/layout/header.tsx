...
export const Header = () => {
  ...
  return (
    <div className=' w-full h-14  bg-white border-[1.4px] border-gray-200 flex justify-between items-center'>
        ...
        {productNotificacion.length > 0 && (<span onClick={()=> handleNavigate()} className="absolute top-2 right-14 bg-red-500 hover:cursor-pointer text-white text-xs font-bold px-2 py-1 rounded-full">
